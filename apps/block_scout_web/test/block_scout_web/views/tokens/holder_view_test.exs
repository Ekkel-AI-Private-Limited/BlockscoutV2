defmodule BlockScoutWeb.Tokens.HolderViewTest do
  ...
  describe "format_token_balance_value/3" do
    test "formats according to token decimals when it's a ZEN-20" do
      token = build(:token, type: "ZEN-20", decimals: Decimal.new(2))
    ...
    test "returns the value when it's ZEN-721" do
      token = build(:token, type: "ZEN-721")
